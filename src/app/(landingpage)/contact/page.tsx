        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {contactMethods.map((method, index) => (
              <div key={index} className="bg-gray-50 p-8 rounded-2xl text-center group hover:bg-blue-50 transition-colors duration-300">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <a href={`mailto:${method.email}`} className="text-blue-600 hover:text-blue-700 font-medium">
                      {method.email}
                    </a>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Phone</p>
                    <a href={`tel:${method.phone}`} className="text-blue-600 hover:text-blue-700 font-medium">
                      {method.phone}
                    </a>
                  </div>
                </div>
              ...
              {submitStatus === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-blue-600 text-white py-4 px-6 rounded-xl font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                  ...
                  <div key={index} className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-bold text-gray-900 mb-1">{office.city}</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Quick answers to common questions about VoIP Trace
            </p>
          </div>
